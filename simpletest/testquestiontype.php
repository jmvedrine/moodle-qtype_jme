...
/**
 * Unit tests for the jme question type class.
 *
 * @package    qtype
 * @subpackage jme
...
require_once($CFG->dirroot . '/question/type/jme/questiontype.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_jme_test extends UnitTestCase {
    ...
    public function test_name() {
        $this->assertEqual($this->qtype->name(), 'jme');
    }
